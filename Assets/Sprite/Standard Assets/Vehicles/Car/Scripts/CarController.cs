...
namespace UnityStandardAssets.Vehicles.Car
{
    ...
    public class CarController : MonoBehaviour
    {
        ...
        private void Start()
        {
            ...
            mevcuthiz = GameObject.FindWithTag("hiz").GetComponent<Text>();
            mevcutvites = GameObject.FindWithTag("vites").GetComponent<Text>();
            Nitroslider = GameObject.FindWithTag("nitro_slider").GetComponent<Image>();
            Kadran = GameObject.FindWithTag("kadran");
            NitrodegerText = GameObject.FindWithTag("nitro_deger").GetComponent<Text>();
